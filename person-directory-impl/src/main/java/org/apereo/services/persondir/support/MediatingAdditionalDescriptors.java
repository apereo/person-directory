...
public class MediatingAdditionalDescriptors implements IAdditionalDescriptors {
    ...
    public void addAttributes(final Map<String, List<Object>> attributes) {
        for (var additionalDescriptors : this.delegateDescriptors) {
    ...
    public List<Object> removeAttribute(final String name) {
        ...
        for (var additionalDescriptors : this.delegateDescriptors) {
            var values = additionalDescriptors.removeAttribute(name);
            if (values != null) {
    ...
    public List<Object> setAttributeValues(final String name, final List<Object> values) {
        ...
        for (var additionalDescriptors : delegateDescriptors) {
            var oldValues = additionalDescriptors.setAttributeValues(name, values);
            if (oldValues != null) {
    ...
    public Object getAttributeValue(final String name) {
        for (var additionalDescriptors : delegateDescriptors) {
            var attributes = additionalDescriptors.getAttributes();
    ...
    public String getName() {
        for (var additionalDescriptors : delegateDescriptors) {
            var name = additionalDescriptors.getName();
            if (name != null) {
                return name;
            }
        }
